  ...
  return (
    ...
    >
      ...
      <ContentParagraph>
        ...
        connected to a fediverse instance, and made shitposts from a set of
        files pertaining to musicians/bands, and sentences. I still haven't
        finished this project, but it is one i'm quite fond of
      </ContentParagraph>
    </CollapsableRow>
  );
};
